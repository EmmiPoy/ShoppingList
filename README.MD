...
--------------- TODO:
- Miten saat fragmenteille kannasta tiedot
- Kategoria-fragmentin itemistä kun klikataan, navigointi product-fragmenttiinm jossa tuolloin näytetään vain sen kategorian tuotteet
